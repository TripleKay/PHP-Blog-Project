                ...
                <div class="card-body">
                    ...
                    <form action="#" method="POST">
                        <div class="form-group">
                            <label for=""><i class="text-primary mr-2 feather-user"></i> Your Name</label>
                        ...
                        <div class="form-group">
                            <label for=""><i class="text-primary mr-2 feather-lock"></i>Confirm Password</label>
                            <input type="password" name="confirm_password" min="8" class="form-control" required>
                        </div>
